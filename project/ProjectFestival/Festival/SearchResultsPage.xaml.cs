...
namespace Festival
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : Festival.Common.LayoutAwarePage
    {
        ...
        private void OnItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(ItemDetailPage), ((FestivalDataItem)e.ClickedItem).UniqueId);
        }

        // Collection of RecipeDataItem collections representing search results
        private Dictionary<string, List<FestivalDataItem>> _results = new Dictionary<string, List<FestivalDataItem>>();
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var groups = FestivalDataSource.GetGroups("AllGroups");
            string query = queryText.ToLower();
            var all = new List<FestivalDataItem>();
            _results.Add("All", all);

            foreach (var group in groups)
            {
                var items = new List<FestivalDataItem>();
        ...
        /// </summary>
        private sealed class Filter : Festival.Common.BindableBase
        {
